...
FIELD_EXTRACTION_TASKS = [
    ...
    {"param_name": "bonus_tiers_detailed", "prompt": "Extract detailed information for each bonus tier. For each tier, provide: tier number, bonus amount, and deposit requirement. IMPORTANT: Keep descriptions VERY SHORT and self-contained. For simple deposit amounts, use numeric values. For complex requirements, use concise phrases (max 35 characters). Examples: 'Set up direct deposit', '$15K + maintain 90 days', 'Open both accounts', '$500/month x 2 months'. Format as valid JSON array with DOUBLE QUOTES: [{\"tier\": 1, \"bonus\": 250, \"deposit\": 2000}, {\"tier\": 2, \"bonus\": 350, \"deposit\": \"Set up direct deposit\"}, {\"tier\": 3, \"bonus\": 500, \"deposit\": \"Open both + $15K deposit\"}]. If single tier, respond with 'Single tier'."},
